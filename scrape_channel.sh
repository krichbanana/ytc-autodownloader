...
./yt-dlp/yt-dlp.sh -s -q -j --ignore-no-formats-error --force-write-archive --download-archive "channel-cached/${channelbase}.url.all" --max-downloads 20 -a - <"${tmppre}.final.url" > "channel-cached/${channelbase}.meta.new"
